...
if (!params.no_umi) {
    process 'create_BAM' {
        ...
        shell:
            ...
            conda activate /cluster/home/rhauser/miniconda3/envs/mpraflow_py27
...
process 'raw_counts'{
    ...
    script:
        if(params.no_umi)
            ...
            set +eu
            source /cluster/home/rhauser/miniconda3/etc/profile.d/conda.sh
            conda activate /cluster/home/rhauser/miniconda3/envs/mpraflow_py36
    ...
    */
    process 'calc_correlations'{
        ...
        script:
            ...
            set +eu
            source /cluster/home/rhauser/miniconda3/etc/profile.d/conda.sh
            conda activate /cluster/home/rhauser/miniconda3/envs/mpraflow_r
