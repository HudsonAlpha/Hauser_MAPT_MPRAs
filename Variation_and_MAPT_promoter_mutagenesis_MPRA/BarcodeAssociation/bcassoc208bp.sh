  GNU nano 5.6.1                                                                                              bcassoc208_onlycalledreadsshorttime2_mapq0cigar.sh                                                                                                         
#! /bin/bash
#SBATCH -p normal
#SBATCH -o MPRAflow_assoc_208_called_shorttime2mapq_%j.out


###change these variables###
workingDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc208/workingcalledmapq"
outputDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc208/outputcalledmapq"
designFile="/cluster/home/rhauser/files/rmhex03/design/varmpradesign_208bp.fasta"
name="assoc_basic_208_called_shorttime2_mapq"
cigar="208M"
