#! /bin/bash
#SBATCH -p normal
#SBATCH -o MPRAflow_assoc_218_called_shorttime2_mapqcigar_%j.out


###change these variables###
workingDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc_reseq/bcassoc218/workingcalledmapq"
outputDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc_reseq/bcassoc218/outputcalledmapq"
designFile="/cluster/home/rhauser/files/rmhex03/design/varmpradesign_218bp.fasta"
name="assoc_basic_218_called_shorttime2_mapq"
cigar="218M"
