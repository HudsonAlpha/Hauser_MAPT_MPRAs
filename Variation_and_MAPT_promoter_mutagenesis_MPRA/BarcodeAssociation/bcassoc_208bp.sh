#! /bin/bash
#SBATCH -p normal
#SBATCH -o MPRAflow_assoc_208_called_shorttime2_mapqcigar_%j.out


###change these variables###
workingDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc_reseq/bcassoc208/workingcalledmapq"
outputDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc_reseq/bcassoc208/outputcalledmapq"
