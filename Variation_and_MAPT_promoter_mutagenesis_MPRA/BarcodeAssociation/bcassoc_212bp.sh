#! /bin/bash
#SBATCH -p normal
#SBATCH -o MPRAflow_assoc_212_called_shorttime2mapq_%j.out


###change these variables###
workingDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc212/workingcalledmapq"
outputDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc212/outputcalledmapq"
designFile="/cluster/home/rhauser/files/rmhex03/design/varmpradesign_212bp.fasta"
name="assoc_basic_212_called_shorttime_mapq"
cigar="212M"
