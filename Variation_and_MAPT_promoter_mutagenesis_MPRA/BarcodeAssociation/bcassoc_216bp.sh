#! /bin/bash
#SBATCH -p normal
#SBATCH -o MPRAflow_assoc_216_called_shorttime2_mapqcigar_%j.out


###change these variables###
workingDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc_reseq/bcassoc216/workingcalledmapq"
outputDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc_reseq/bcassoc216/outputcalledmapq"
designFile="/cluster/home/rhauser/files/rmhex03/design/varmpradesign_216bp.fasta"
name="assoc_basic_216_called_shorttime2_mapq"
cigar="216M"
