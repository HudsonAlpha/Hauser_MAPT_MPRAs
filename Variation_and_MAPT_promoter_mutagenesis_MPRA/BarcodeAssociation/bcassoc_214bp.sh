#! /bin/bash
#SBATCH -p normal
#SBATCH -o MPRAflow_assoc_214_called_shorttime2_mapqcigar_%j.out


###change these variables###
workingDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc_reseq/bcassoc214/workingcalledmapq"
outputDir="/cluster/home/rhauser/files/rmhex03/bcassoc/bcassoc_reseq/bcassoc214/outputcalledmapq"
designFile="/cluster/home/rhauser/files/rmhex03/design/varmpradesign_214bp.fasta"
name="assoc_basic_214_called_shorttime2_mapq"
cigar="214M"
